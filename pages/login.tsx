...
const Login = () => {
  return (
    <>
      <SkeletonLayout>
        <div className="h-center flex flex-col space-y-5 justify-center items-center">
          <h3 className="text-2xl font-semibold text-secondary leading-relaxed">
            Log in{' '}
            <span className="text-xl font-medium text-dark-primary">or</span>{' '}
            Sign up
          </h3>
          ...
          <div className="flex flex-col space-y-2 justify-center items-center">
            <Link href="/auth/github/login">
              <a
                ...
                className="hover:text-white hover:bg-[#0E1117] focus:outline-none focus:ring-2 focus:ring-offset-1 focus:text-white focus:bg-[#0E1117] transition-colors duration-150 flex flex-row justify-center items-center border rounded-lg px-3 py-2 space-x-1.5"
              >
                <UilGithub className="w-5 aspect-square" />
